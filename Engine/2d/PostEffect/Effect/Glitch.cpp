...
PSOProperty Glitch::CreatePipelineStateObject()
{
    ...
    property.pixelShaderBlob = CompileShader(L"Resources/shader/Glitch.PS.hlsl",
...
void Glitch::CommandRootParameter(PostProcess* postProcess)
{
    DirectXCommon* sDirectXCommon = DirectXCommon::GetInstance();
...
std::vector<D3D12_ROOT_PARAMETER> Glitch::CreateRootParamerter(std::vector<D3D12_DESCRIPTOR_RANGE>& descriptorRange) {
...
std::vector<D3D12_STATIC_SAMPLER_DESC> Glitch::CreateSampler() {
...
D3D12_ROOT_SIGNATURE_DESC Glitch::CreateRootSignature(PSOProperty& pso, std::vector<D3D12_ROOT_PARAMETER>& rootParameters, std::vector<D3D12_STATIC_SAMPLER_DESC>& samplers) {
...
D3D12_INPUT_LAYOUT_DESC Glitch::SetInputLayout() {
...
D3D12_BLEND_DESC Glitch::SetBlendState() {
    D3D12_BLEND_DESC blendDesc{};
    blendDesc.RenderTarget[0].RenderTargetWriteMask = D3D12_COLOR_WRITE_ENABLE_ALL;
    return blendDesc;
}

D3D12_RASTERIZER_DESC Glitch::SetRasterizerState() {
...
D3D12_DEPTH_STENCIL_DESC Glitch::CreateDepth() {
