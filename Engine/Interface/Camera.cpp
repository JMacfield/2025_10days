...
Camera::Camera() {
	//// ジャンプ音のハンドル
	//AudioJumphandle_ = Audio::GetInstance()->SoundLoadWave("Resources/game/Audio/Jump.wav");

	//// ポータル音のハンドル
	//AudioPortalhandle_ = Audio::GetInstance()->SoundLoadWave("Resources/game/Audio/portal.wav");
}
